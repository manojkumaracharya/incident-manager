...
function processOutput(jsonString){
    ...
    for (var i=0;i<rows.length;i++){
      ...
      html+= '<td><button  class="btn btn-sm slack" title="create Slack channel" style="background: #ccc url(images/slack.png); padding: 0.4em 1em;no-repeat;height:40px;width:45px"></button></td>'
    }
    html += '</tbody>' ;
